...
# image background    
spring_image = open_resize("welcome_UI_DUT/muaxuan.jpg")
winter_image = open_resize("welcome_UI_DUT/muadong.jpg")
summer_image = open_resize("welcome_UI_DUT/muahe.jpg")
autumn_image = open_resize("welcome_UI_DUT/muathu.jpg")
...
image2 = Image.open("welcome_UI_DUT/UDN.png")
...
image = Image.open("welcome_UI_DUT/DUT.jpg")
...
name_text = Label(text_frame, text="PGS.TS Phạm Văn Tuấn", font=("Arial", 40, 'bold'), fg = '#0b5394', bg='white', padx=60)
name_text.pack(pady=20)

tilte_text = Label(text_frame, text="Trưởng Phòng Khảo thí và đảm bảo chất lượng giáo dục DUT", font=("Arial", 40), fg = '#0b5394', bg='white', padx=50, wraplength=1000)
